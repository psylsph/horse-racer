...
test.describe('Full User Flow', () => {
  ...
  test('should handle navigation between screens', async ({ page }) => {
    await clearLocalStorage(page);
    await page.goto('/');
    await waitForAppLoad(page);
  ...
  test('should verify accessibility throughout flow', async ({ page }) => {
    await clearLocalStorage(page);
    await page.goto('/');
    await waitForAppLoad(page);
  ...
  test('should verify performance expectations', async ({ page }) => {
    await clearLocalStorage(page);
